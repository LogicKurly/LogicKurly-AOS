...
class RequireAdapter(var context: Context, var popularList: ArrayList<String>, var selectedList : ArrayList<Int>): RecyclerView.Adapter<RequireAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.require_item, parent, false)
